...
The [vite config](./vite.config.ts#L16-L17) is currently configured to use [Nitro v3](https://v3.nitro.build/) (alpha) to deploy on Netlify, but can be easily switched to other providers.
...
- [Nitro v3 alpha](https://v3.nitro.build/docs/migration) - We're currently using Nitro v3 alpha by default.
